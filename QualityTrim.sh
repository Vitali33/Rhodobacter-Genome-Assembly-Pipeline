...
function trim {
    ...
    ~/WorkingDirectory/NGS/data/trimmed/paired/Rhodo.R1.paired.fastq \ # Output file for paired reads, forward
    ~/WorkingDirectory/NGS/data/trimmed/unpaired/Rhodo.R1.unpaired.fastq \ # Output file for unpaired reads, forward
    ~/WorkingDirectory/NGS/data/trimmed/paired/Rhodo.R2.paired.fastq \ # Output file for paired reads, reverse
    ~/WorkingDirectory/NGS/data/trimmed/unpaired/Rhodo.R2.unpaired.fastq \ # Output file for unpaired reads, reverse
